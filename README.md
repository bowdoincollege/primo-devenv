...
Anyone who just needs the package.zip file to upload into the view customization (or Primo Studio, if you want to play with it), you can go to the packages directory to get [Bowdoin's](/packages/01CBB_BOWC-BOWDOIN.zip) or [CBB's](/packages/01CBB_NETWORK-01CBB_NETWORK_UNION.zip).
